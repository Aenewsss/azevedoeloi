        ...
        <div className="container mt-5">
            ...
            <section className="row mt-5">
                <div className="col-md-4 mt-md-0 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_FAMILIA} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
                        ...
                        <div className="text-main d-flex gap-2 align-items-center">
                            <span className="fs-5">Saiba mais</span>
                            <span className="fs-2 mb-1">→</span>
                        </div>
                    </Link>
                </div>
                <div className="col-md-4 mt-md-0 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_SUCESSORIO} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
                ...
                <div className="col-md-4 mt-md-0 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_IMOBILIARIO} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
                ...
                <div className="col-md-4 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_CONDOMINIAL} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
                ...
                <div className="col-md-4 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_DO_CONSUMIDOR} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
                ...
                <div className="col-md-4 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_PREVIDENCIARIO} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
                ...
                <div className="col-md-4 mt-4">
                    <Link href={PathEnum.AREA_DIREITO_BANCARIO} className="justify-content-center h-areas-cards bg-white rounded px-5 py-4 d-flex flex-column gap-3 align-items-center">
